...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            parameters=[{
                'yaml_filename': '/home/neorobot/my_map_new.yaml',
                'use_sim_time': False
            }]
        ),
        ...
        # Node(
        #     package='ap_uart_rx',
        #     executable='scan_fixed_node',
        #     name='scan_fixed_node',
        #     output='screen'
        # ),
        ...
        # # ===== Safety Manager =====
        # Node(
        #     package='neo_robot_safety',    # ← safety_manager가 들어있는 패키지명
        #     executable='safety_manager',   # ← C++ 빌드된 실행파일명
        #     name='safety_manager',
        #     output='screen'
        # ),
